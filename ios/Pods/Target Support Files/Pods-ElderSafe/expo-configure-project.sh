...
with_node \
  ...
  --target "/Users/bob-brown/Downloads/eldersafe/ios/Pods/Target Support Files/Pods-ElderSafe/ExpoModulesProvider.swift" \
  --entitlement "/Users/bob-brown/Downloads/eldersafe/ios/ElderSafe/ElderSafe.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-splash-screen"
